  ...
  return (
    <section id={id} className={`py-0 ${className}`}>
      <div className="relative rounded-t-2xl overflow-hidden bg-black">
        ...
        <Container>
          <div
            className={`grid items-center ${compact ? "min-h-[420px] sm:min-h-[480px] lg:min-h-[540px] py-10" : "min-h-[520px] sm:min-h-[580px] lg:min-h-[640px] py-14"}`}>
            {(title || subtitle) && (
              <header className={`${compact ? "mb-6" : "mb-10"} ${center ? "text-center" : ""}`}>
                {subtitle && (
                  <div
