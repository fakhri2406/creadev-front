            ...
            <section className="relative overflow-hidden bg-black">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-10 lg:gap-12 items-start">
                        ...
                        <div className="relative hidden lg:block h-[260px] xl:h-[300px]">
                            ...
                            <div
                                ...
                                <div className="text-sm text-center">Modern və problemlərdə həlledici rola malik veb saytlar</div>
                            </div>
                        </div>
                    </div>
                    {/* Hero gallery */}
                ...
                <div className="pointer-events-none absolute inset-x-0 bottom-0 z-0 flex justify-center">
                    <img
                        src="/hero-image.png"
                        alt="Hero background"
                        className="w-auto max-w-none h-[150vh] object-contain opacity-78"
                    />
                </div>
            </section>
            ...
            <Section subtitle={<Badge icon={<Target/>}>necə işləyirik?</Badge>} title={<>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <ProcessCard icon={<Idea className="w-5 h-5"/>} title="İdeyanız"
                                 desc="İlk olaraq, komandamıza (və ya süni intellektə) layihəniz üçün uyğun olan istənilən formada detallı təqdimatı təhvil verirsiniz." step="1-ci addım"/>
                    <ProcessCard icon={<Analysis className="w-5 h-5"/>} title="Analiz"
                                 desc="Komandamız verdiyiniz təqdimatı dərin şəkildə analiz edir. Təqdimat əsasında platforma üçün zəruri olan məlumatlar qeyd olunur." step="2-ci addım"/>
                    <ProcessCard icon={<Backend className="w-5 h-5"/>} title="Backend"
                                 desc="Aparılan qeydlərə əsasən bütün təhlükəsizlik şərtləri nəzərə alınmaqla, keyfiyyətli və sürətli backend kodu yazılır və host edilir." step="3-cü addım"/>
                    <ProcessCard icon={<Frontend className="w-5 h-5"/>} title="Frontend"
                                 desc="Backend tamamlanandan sonra, developerlərimiz müasir dizayn trendlərinə uyğun olaraq, cəlbedici frontend yaradırlar." step="4-cü addım"/>
                </div>
